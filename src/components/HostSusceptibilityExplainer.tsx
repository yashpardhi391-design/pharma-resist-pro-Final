      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/70 p-5 space-y-3 shadow-sm transition-colors">
          ...
          <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
            <strong>In Person 2 (Resistant/Protected):</strong> Healthy neutrophils (PMNs) perform rapid chemotaxis, engulf bacteria, and kill them via oxidative bursts (H₂O₂ &amp; myeloperoxidase).
          </p>
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/80 p-6 space-y-6 shadow-sm dark:shadow-xl transition-colors">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200 dark:border-slate-800 pb-4">
          ...
          <div className="flex items-center space-x-2">
            <button
              onClick={() => {
                // Reset to Healthy Person 2 profile
              ...
              className="px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-300 text-xs font-medium border border-slate-200 dark:border-slate-700 transition-colors cursor-pointer"
            >
              Simulate Healthy Person 2
            </button>
            <button
              onClick={() => {
                // Reset to ICU Person 1 profile
                setHasDiabetes(true);
                setHasCatheter(true);
              ...
              className="px-3 py-1.5 rounded-lg bg-rose-50 hover:bg-rose-100 dark:bg-rose-950/40 dark:hover:bg-rose-900/40 text-rose-800 dark:text-rose-300 text-xs font-medium border border-rose-200 dark:border-rose-500/40 transition-colors cursor-pointer"
            >
              Simulate Compromised Person 1
            </button>
          </div>
        </div>

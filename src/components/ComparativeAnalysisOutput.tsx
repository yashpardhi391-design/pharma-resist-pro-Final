  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="glass-panel-glow rounded-2xl p-6 border border-slate-200 dark:border-slate-700/80 flex flex-col items-center justify-center text-center relative overflow-hidden">
        ...
        <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-4 content-center">
          ...
          <div className="sm:col-span-3 rounded-xl glass-panel p-4 border border-slate-200 dark:border-slate-700/80 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-700 dark:text-slate-300">
      ...
      <div
        ...
        className="glass-panel rounded-2xl border border-slate-200 dark:border-slate-700/80 overflow-hidden shadow-sm dark:shadow-xl"
      >
        {/* Table Toolbar */}
      ...
      <div
        id="ai-insights-box"
        className="glass-panel-glow rounded-2xl p-6 sm:p-7 border border-teal-300 dark:border-teal-500/40 bg-gradient-to-br from-teal-50/60 via-white to-cyan-50/60 dark:from-slate-900/95 dark:via-slate-900/90 dark:to-[#0A1628]/95 shadow-sm dark:shadow-2xl relative overflow-hidden transition-colors"
      >
          ...
          <div className="bg-teal-50/50 dark:bg-slate-950/60 border border-teal-200 dark:border-teal-500/30 rounded-xl p-5 space-y-3.5 shadow-xs">
            ...
            {patient1.clinicalParams ? (
              <div className="space-y-2.5 text-xs">
                ...
                <div className="bg-white dark:bg-slate-900 p-3 rounded-lg border border-slate-200/90 dark:border-slate-800 shadow-xs">
                  <span className="text-[10px] uppercase font-mono text-slate-500 dark:text-slate-400 block font-semibold">Prior Antibiotic Misuse History:</span>
                  <span className="text-xs text-slate-700 dark:text-slate-200">{patient1.clinicalParams.priorAntibioticMisuse || "None reported"}</span>
                </div>

                <div className="flex items-center justify-between bg-white dark:bg-slate-900 p-3 rounded-lg border border-slate-200/90 dark:border-slate-800 font-mono text-[11px] shadow-xs">
                  <span className="text-slate-700 dark:text-slate-300">Virulence: <strong className="text-purple-700 dark:text-purple-300">{patient1.clinicalParams.pathogenVirulenceIndex}</strong></span>
                  <span className="text-slate-700 dark:text-slate-300">Immunity: <strong className="text-teal-700 dark:text-teal-300">{patient1.clinicalParams.immunityCapacity}</strong></span>
                </div>
              </div>
            ) : (
          ...
          <div className="bg-cyan-50/50 dark:bg-slate-950/60 border border-cyan-200 dark:border-cyan-500/30 rounded-xl p-5 space-y-3.5 shadow-xs">
            ...
            {patient2.clinicalParams ? (
              <div className="space-y-2.5 text-xs">
                ...
                <div className="bg-white dark:bg-slate-900 p-3 rounded-lg border border-slate-200/90 dark:border-slate-800 shadow-xs">
                  <span className="text-[10px] uppercase font-mono text-slate-500 dark:text-slate-400 block font-semibold">Prior Antibiotic Misuse History:</span>
                  <span className="text-xs text-slate-700 dark:text-slate-200">{patient2.clinicalParams.priorAntibioticMisuse || "None reported"}</span>
                </div>

                <div className="flex items-center justify-between bg-white dark:bg-slate-900 p-3 rounded-lg border border-slate-200/90 dark:border-slate-800 font-mono text-[11px] shadow-xs">
                  <span className="text-slate-700 dark:text-slate-300">Virulence: <strong className="text-purple-700 dark:text-purple-300">{patient2.clinicalParams.pathogenVirulenceIndex}</strong></span>
                  <span className="text-slate-700 dark:text-slate-300">Immunity: <strong className="text-teal-700 dark:text-teal-300">{patient2.clinicalParams.immunityCapacity}</strong></span>
                </div>
              </div>
            ) : (

...
interface NavbarProps {
  activeTab: "overview" | "scanner" | "hospital" | "analytics" | "records";
  onSelectTab: (tab: "overview" | "scanner" | "hospital" | "analytics" | "records") => void;
...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const navItems = [
    ...
    { id: "scanner" as const, label: "Dual Scanner", icon: ScanLine },
    { id: "hospital" as const, label: "Hospital Suite", icon: Building2, highlight: true, highlightBadge: "ICU Lab" },
    ...
    <header className="sticky top-0 z-40 w-full border-b border-slate-200 dark:border-slate-800 bg-white/95 dark:bg-[#0B1120]/95 backdrop-blur-md transition-colors duration-200">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Desktop Navigation Links (Visible on lg+ screens to avoid cramping) */}
          ...
          {/* Right Area: Theme Toggle, Verify Code, AI Status, Profile */}
      ...
      {/* Mobile Quick-Tabs Bar (Scrollable on small screens for instant access) */}

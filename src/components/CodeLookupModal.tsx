  ...
  const handleSearch = (codeToSearch?: string) => {
    ...
    if (found) {
      ...
      const p1 = patient1 || {
        ...
        clinicalParams: {
          bloodGroup: "A+",
          anemia: { status: "Moderate Anemia", hemoglobin: 9.8 },
          vitals: { weightKg: 78, heightCm: 175, bmi: 25.5 },
          bloodReport: { wbcCount: 16800, platelets: 210000, crp: 48, serumCreatinine: 1.4, eGfr: 52 },
          pathogenVirulenceIndex: "High Virulence (Biofilm+)",
          immunityCapacity: "Low (Immunocompromised)",
        },
      };
      const p2 = patient2 || {
        id: "P-8842",
        ...
        age: 71,
        ward: "Step-Down Ward 2B",
        pathogen: "Acinetobacter baumannii (CRAB)",
        specimen: "Surgical Wound Swab",
        clinicalParams: {
          bloodGroup: "O+",
          anemia: { status: "Mild Anemia", hemoglobin: 11.2 },
          vitals: { weightKg: 84, heightCm: 172, bmi: 28.4 },
          bloodReport: { wbcCount: 13400, platelets: 185000, crp: 32, serumCreatinine: 1.8, eGfr: 38 },
          pathogenVirulenceIndex: "Severe (Multi-Replicon)",
          immunityCapacity: "Moderate-Low (Post-Op Frailty)",
        },
      };
      ...
      const virtualRecord: SavedComparativeRecord = {
        ...
        patient1: {
          ...
          specimen: p1.specimen,
          fileName: p1.file?.name,
          clinicalParams: p1.clinicalParams,
        },
        patient2: {
          id: p2.id,
          name: p2.name,
          ...
          specimen: p2.specimen,
          fileName: p2.file?.name,
          clinicalParams: p2.clinicalParams,
        },

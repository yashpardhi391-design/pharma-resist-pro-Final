  ...
  return (
    <section id="analytics-export-section" className="relative py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <button
              ...
              disabled={!analysis}
              className="flex items-center space-x-2 px-4 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 hover:text-slate-950 dark:hover:text-white border border-slate-300 dark:border-slate-700 text-xs font-semibold transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <FileSpreadsheet className="w-4 h-4 text-teal-600 dark:text-emerald-400" />
            ...
            <button
              ...
              className={`flex items-center space-x-2 px-4 py-2.5 rounded-xl border text-xs font-semibold transition-all cursor-pointer ${
                saveSuccess
                  ...
                  : "bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 border-slate-300 dark:border-slate-700 text-slate-800 dark:text-slate-200 hover:text-slate-950 dark:hover:text-white"
        ...
        <div className="glass-panel-glow rounded-2xl p-5 sm:p-6 border border-slate-200 dark:border-slate-700/80 shadow-sm dark:shadow-xl">
          {/* Drug Class Toggles */}
              ...
              <button
                ...
                className={`flex items-center space-x-1.5 px-3 py-1 rounded-full border transition-all cursor-pointer ${
                  activeLines.Carbapenems
                    ? "bg-teal-50 dark:bg-teal-950/70 text-teal-700 dark:text-teal-300 border-teal-300 dark:border-teal-500/50"
                    : "bg-slate-100 dark:bg-slate-800/50 text-slate-400 dark:text-slate-500 border-slate-200 dark:border-slate-700"
                }`}
              >
              ...
              <button
                ...
                className={`flex items-center space-x-1.5 px-3 py-1 rounded-full border transition-all cursor-pointer ${
                  activeLines.Fluoroquinolones
                    ? "bg-cyan-50 dark:bg-cyan-950/70 text-cyan-700 dark:text-cyan-300 border-cyan-300 dark:border-cyan-500/50"
                    : "bg-slate-100 dark:bg-slate-800/50 text-slate-400 dark:text-slate-500 border-slate-200 dark:border-slate-700"
                }`}
              >
              ...
              <button
                ...
                className={`flex items-center space-x-1.5 px-3 py-1 rounded-full border transition-all cursor-pointer ${
                  activeLines.Cephalosporins
                    ? "bg-rose-50 dark:bg-rose-950/70 text-rose-700 dark:text-rose-300 border-rose-300 dark:border-rose-500/50"
                    : "bg-slate-100 dark:bg-slate-800/50 text-slate-400 dark:text-slate-500 border-slate-200 dark:border-slate-700"
                }`}
              >
              ...
              <button
                ...
                className={`flex items-center space-x-1.5 px-3 py-1 rounded-full border transition-all cursor-pointer ${
                  activeLines.Aminoglycosides
                    ? "bg-amber-50 dark:bg-amber-950/70 text-amber-700 dark:text-amber-300 border-amber-300 dark:border-amber-500/50"
                    : "bg-slate-100 dark:bg-slate-800/50 text-slate-400 dark:text-slate-500 border-slate-200 dark:border-slate-700"
                }`}
              >
